            ...
            <div class="flex items-center gap-3 w-full lg:w-auto">
                ...
                @if($slot->isNotEmpty())
                    <button 
                        ...
                        class="flex-1 lg:flex-none inline-flex items-center justify-center gap-2 px-6 py-5 border rounded-2xl text-sm font-bold transition-all hover:bg-slate-50 active:scale-95 shadow-theme-xs dark:hover:bg-slate-800 cursor-pointer"
                    >
                ...
                <a 
                    href="{{ url()->current() }}" 
                    class="inline-flex items-center justify-center p-5 text-slate-400 hover:text-slate-600 hover:bg-slate-50 rounded-2xl transition-all active:scale-95 bg-white border border-slate-200 shadow-theme-xs dark:bg-slate-800/50 dark:border-slate-700 dark:hover:bg-slate-800 cursor-pointer"
                ...
                <button 
                    type="submit" 
                    class="flex-1 lg:flex-none inline-flex items-center justify-center gap-2 px-12 py-5 bg-brand-500 text-white rounded-2xl text-base font-black shadow-lg shadow-brand-500/30 hover:bg-brand-600 active:scale-[0.98] transition-all dark:shadow-brand-500/20 cursor-pointer"
                >
                    Buscar
                </button>
            </div>
