            ...
            <form action="{{ route('service-orders.store') }}" method="POST" class="space-y-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        <x-input label="Nombre del Cliente" name="customer_name" required placeholder="Ej. Carlos Rodríguez" />
                        <x-input label="Teléfono de Contacto" name="customer_phone" placeholder="Ej. 300 456 7890" />
                    </div>
                </div>
